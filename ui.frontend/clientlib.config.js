module.exports = {
    ...
    clientLibRoot: "./../ui.apps/src/main/content/jcr_root/apps/aem-fed/clientlibs",

    libs: [
        {
            name: "clientlib-dependencies",
            allowProxy: true,
            categories: ["aem-fed.dependencies"],
        ...
        },
        {
            name: "clientlib-site",
            allowProxy: true,
            categories: ["aem-fed.site"],
            dependencies: ["aem-fed.dependencies"],
            serializationFormat: "xml",
            cssProcessor : ["default:none", "min:none"],
            jsProcessor: ["default:none", "min:none"],
            assets: {
